...
Messages = [
	...
	NetMessageEx("Sv_GameSettings", "game-settings@netmsg.ddnet.org", [
		NetIntRange("m_OldTeleportWeapons", 0, 1),
		NetIntRange("m_OldTeleportHook", 0, 1),
		NetIntRange("m_TeleportHoldHook", 0, 1),
		NetIntRange("m_TeleportLoseWeapons", 0, 1),
		NetIntRange("m_Deepfly", 0, 1),
		NetIntRange("m_DestroyBulletsOnDeath", 0, 1),
		NetIntRange("m_DestroyLasersOnDeath", 0, 1),
		NetIntRange("m_Hit", 0, 1),
		NetIntRange("m_EndlessDrag", 0, 1),
		NetIntRange("m_FreezeDelay", 1, 30),
		NetIntRange("m_SaveWorseScores", 0, 1),
		NetIntRange("m_Pauseable", 0, 1),
		NetIntRange("m_Team", 0, 3),
		NetIntRange("m_MinTeamSize", 1, 'MAX_CLIENTS'),
		NetIntRange("m_MaxTeamSize", 1, 'MAX_CLIENTS'),
		NetIntRange("m_OldLaser", 0, 1),
		NetIntRange("m_NoWeakHook", 0, 1),
		NetIntRange("m_ResetPickups", 0, 1),
		NetIntRange("m_ShowOthersDefault", 0, 2),
		NetIntRange("m_PlasmaRange", 1, 99999),
		NetIntRange("m_PlasmaPerSec", 0, 50),
		NetIntRange("m_DraggerRange", 1, 99999),
		NetIntRange("m_SoloServer", 0, 1),
	]),
]
