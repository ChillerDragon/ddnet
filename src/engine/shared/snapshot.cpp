...
int CSnapshotDelta::DebugDumpDelta(const void *pSrcData, int DataSize, bool Sixup)
{
	...
	{
		dbg_msg("delta_dump", "|  delta size too small. Should at least fit the empty delta header");
		return -505;
	}
