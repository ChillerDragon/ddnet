...
public:
	...
	int SnapGetTick(int SnapId, int Dummy = -1) const override;
	...
	int TranslateSysMsg(int *pMsgId, bool System, CUnpacker *pUnpacker, CPacker &Packer, CNetChunk *pPacket, bool &IsExMsg);
