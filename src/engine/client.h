...
public:
	...
	virtual int OnDemoRecSnap7(class CSnapshot *pFrom, class CSnapshot *pTo) = 0;
	virtual int TranslateSnap(class CSnapshot *pSnapSix, class CSnapshot *pSnapSeven, int Conn, bool Dummy) = 0;
};
