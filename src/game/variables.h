...
MACRO_CONFIG_STR(ClPlayer7Skin, player7_skin, 24, "default", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin")
MACRO_CONFIG_STR(ClPlayer7SkinBody, player7_skin_body, 24, "standard", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin body")
MACRO_CONFIG_STR(ClPlayer7SkinMarking, player7_skin_marking, 24, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin marking")
MACRO_CONFIG_STR(ClPlayer7SkinDecoration, player7_skin_decoration, 24, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin decoration")
MACRO_CONFIG_STR(ClPlayer7SkinHands, player7_skin_hands, 24, "standard", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin hands")
MACRO_CONFIG_STR(ClPlayer7SkinFeet, player7_skin_feet, 24, "standard", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin feet")
MACRO_CONFIG_STR(ClPlayer7SkinEyes, player7_skin_eyes, 24, "standard", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Player skin eyes")
