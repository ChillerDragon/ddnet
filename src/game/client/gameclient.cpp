...
bool CGameClient::GotWantedSkin7(bool Dummy)
{
	...
	{
		if(str_comp(m_aClients[m_aLocalIds[(int)Dummy]].m_aaSkinPartNames[SkinPart], CSkins7::ms_apSkinVariables[(int)Dummy][SkinPart]))
			return false;
		if(m_aClients[m_aLocalIds[(int)Dummy]].m_aUseCustomColors[SkinPart] != *CSkins7::ms_apUCCVariables[(int)Dummy][SkinPart])
			return false;
		if(m_aClients[m_aLocalIds[(int)Dummy]].m_aSkinPartColors[SkinPart] != *CSkins7::ms_apColorVariables[(int)Dummy][SkinPart])
			return false;
	}
