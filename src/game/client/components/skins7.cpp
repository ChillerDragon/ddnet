...
void CSkins7::OnInit()
{
	...
	ms_apColorVariables[Dummy][SKINPART_BODY] = (int *)&Config()->m_ClPlayer7ColorBody;
	ms_apColorVariables[Dummy][SKINPART_MARKING] = (int *)&Config()->m_ClPlayer7ColorMarking;
	ms_apColorVariables[Dummy][SKINPART_DECORATION] = (int *)&Config()->m_ClPlayer7ColorDecoration;
	ms_apColorVariables[Dummy][SKINPART_HANDS] = (int *)&Config()->m_ClPlayer7ColorHands;
	ms_apColorVariables[Dummy][SKINPART_FEET] = (int *)&Config()->m_ClPlayer7ColorFeet;
	ms_apColorVariables[Dummy][SKINPART_EYES] = (int *)&Config()->m_ClPlayer7ColorEyes;
	...
	ms_apColorVariables[Dummy][SKINPART_BODY] = (int *)&Config()->m_ClDummy7ColorBody;
	ms_apColorVariables[Dummy][SKINPART_MARKING] = (int *)&Config()->m_ClDummy7ColorMarking;
	ms_apColorVariables[Dummy][SKINPART_DECORATION] = (int *)&Config()->m_ClDummy7ColorDecoration;
	ms_apColorVariables[Dummy][SKINPART_HANDS] = (int *)&Config()->m_ClDummy7ColorHands;
	ms_apColorVariables[Dummy][SKINPART_FEET] = (int *)&Config()->m_ClDummy7ColorFeet;
	ms_apColorVariables[Dummy][SKINPART_EYES] = (int *)&Config()->m_ClDummy7ColorEyes;
